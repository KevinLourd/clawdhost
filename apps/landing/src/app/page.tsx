...
export default function Home() {
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      />
      {/* Gradient orbs - hidden on very small screens for performance */}
      <div className="hidden sm:block absolute top-0 left-1/4 w-[300px] sm:w-[400px] md:w-[600px] h-[300px] sm:h-[400px] md:h-[600px] bg-[#E87C7C]/10 rounded-full blur-3xl -z-10" />
      <div className="hidden sm:block absolute top-1/3 right-0 w-[250px] sm:w-[350px] md:w-[500px] h-[250px] sm:h-[350px] md:h-[500px] bg-[#A8D8EA]/20 rounded-full blur-3xl -z-10" />
      <div className="hidden sm:block absolute bottom-0 left-0 w-[200px] sm:w-[300px] md:w-[400px] h-[200px] sm:h-[300px] md:h-[400px] bg-[#FFB6C1]/10 rounded-full blur-3xl -z-10" />
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2 sm:gap-4 md:gap-6">
            ...
            <a 
              ...
              className="text-sm font-medium px-3 sm:px-4 py-2 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
            >
              Sign In
            </a>
          </nav>
