          ...
          <div className="w-full max-w-sm space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">
                Get started with your free AI assistant
              </p>
            </div>
            ...
            <p className="text-center text-xs text-muted-foreground">
              ...
              <Link href="https://clawdhost.tech/terms" className="text-primary hover:underline">
                Terms
              </Link>
              {" "}and{" "}
              <Link href="https://clawdhost.tech/privacy" className="text-primary hover:underline">
                Privacy Policy
              </Link>
            </p>
